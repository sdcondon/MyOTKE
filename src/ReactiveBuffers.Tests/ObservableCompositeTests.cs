...
public class ObservableCompositeTests
{
    public static IEnumerable<object[]> FlattenTestCases
    {
        get
        {
            static object[][] MakeTestCases(Action<TestCase> action, ICollection<string> expectedObservations) =>
            [
                [action, expectedObservations, false],
                [action, expectedObservations, true],
            ];
            ...
            return new List<object[][]>()
            {
                ...
                MakeTestCases( // grandparent removal
                    ...
                    ["0+", "0=0", "1+", "1=1", "2+", "2=2", "3+", "3=3", "1=4", "2=5", "3=6", "1-", "2-", "3-"]),
                ...
                MakeTestCases( // sibling independence
                    ...
                    ["0+", "0=0", "1+", "1=1", "2+", "2=2", "3+", "3=11", "4+", "4=21", "1-", "3-", "4=22"]),
            }
            .SelectMany(a => a);
        }
    }
    ...
    {
        private readonly Dictionary<string, object> subjectMonitor = [];
