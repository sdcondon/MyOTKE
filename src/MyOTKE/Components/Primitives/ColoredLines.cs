...
public class ColoredLines : IComponent
{
    ...
    private ListBufferBuilder<Vertex> linesBufferBuilder;
    private ListBuffer<Vertex> linesBuffer;
    ...
    public ColoredLines(IViewProjection viewProjection)
    {
        ...
        linesBufferBuilder = new ListBufferBuilder<Vertex>(
    ...
    public void AddLine(Vector3 from, Vector3 to)
    {
        ...
        var bufferItem = linesBuffer.Add();
        lines.Add(new Line(bufferItem, from, to));
    }
    ...
    private class Line
    {
        private readonly IListBufferItem<Vertex> bufferItem;
        private Vector3 from;
        private Vector3 to;

        public Line(IListBufferItem<Vertex> bufferItem, Vector3 from, Vector3 to)
        {
        ...
        private void SetBufferItem()
        {
            bufferItem.Set(
            [
                new Vertex(From, Color.White(), From),
                new Vertex(To, Color.White(), To)
            ]);
        }
    }
}
